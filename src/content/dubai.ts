...
export const dubaiModels = {
  ...
  rows: [
    ...
    {
      id: "licence",
      label: "Trade licence & KHDA permit",
      foco: "Held by the Master Franchisee",
      fofo: "Held by you",
    },
    {
      id: "staff",
      label: "Employment of staff",
      foco: "Master Franchisee",
      fofo: "You",
    },
    {
      id: "ops",
      label: "Day-to-day operation",
      foco: "Master Franchisee",
      fofo: "You, supported by the Master Franchisee",
    },
    {
      id: "academics",
      label: "Curriculum & academic delivery",
      foco: "Master Franchisee",
      fofo: "You, supported by the Master Franchisee",
    },
    {
      ...
      foco: "Consideration for the use of the asset, calculated on gross fee collections",
      fofo: "The operating surplus, after fees and costs",
    },
    {
      id: "mfreturn",
      label: "Return to the Master Franchisee",
      foco: "Net profit after all income and expenses, including what it pays you",
      fofo: "Consideration for the use of brand, licences, IP and curriculum",
    },
    {
      id: "cost",
      label: "Operating cost exposure",
      foco: "None at centre level",
      fofo: "Full",
    },
    {
      id: "khda",
      label: "Regulatory liability to KHDA",
      foco: "Master Franchisee",
      fofo: "You",
    },
    {
