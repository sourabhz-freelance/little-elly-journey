/** Section 09 — What a master franchise partner needs to bring. */
export const requirementsContent = {
  kicker: "What it takes",
  headline: ["What a master franchise", "partner brings."],
  sub: "Straightforward, and far less than most people expect.",
  groups: [
    {
      id: "space",
      icon: "Ruler",
